...
class UrlTransformerTest extends FunSuite with BeforeAndAfterEach {
  ...
  test("testTransformToInternalUrl") {
    val result = transformer.transformToInternalUrl("https://www.nflgamepass.com/api/en/content/v5/mobile/teams/{u.preferredTeam}/details", "test.com", 9000)
    assert(result == "http://test.com:9000/api/en/content/v5/mobile/teams/{u.preferredTeam}/details?host=www.nflgamepass.com&scheme=https")
  }
}
